...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 class="text-4xl font-serif font-bold text-[var(--color-forest-green)] mb-12">Our Journeys</h1>
        ...
        @else
            <p class="text-lg text-[var(--color-earth-brown)]">No journeys available yet.</p>
        @endif
    </div>
@endsection
