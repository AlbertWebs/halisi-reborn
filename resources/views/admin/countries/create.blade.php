...
@section('content')
    <form method="POST" action="{{ route('admin.countries.store') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="flex justify-end space-x-4">
            ...
            <button type="submit" class="px-6 py-2 bg-[var(--color-forest-green)] text-white rounded-[var(--radius-button)] hover:bg-opacity-90 transition-colors font-medium cursor-pointer focus:outline-none focus:ring-2 focus:ring-[var(--color-forest-green)] focus:ring-offset-2">
                Create Country
            </button>
        </div>
    </form>
