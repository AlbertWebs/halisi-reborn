...
@section('content')
    ...
    <section class="journey-cta-section py-20 md:py-28 relative">
        ...
        <div class="js-scroll relative max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <button type="button" id="journey-book-open" class="inline-flex items-center justify-center gap-3 rounded-[var(--radius-button)] border border-[var(--color-forest-green)] bg-[var(--color-forest-green)] text-white font-semibold uppercase tracking-[0.04em] text-base px-10 py-5 hover:bg-[var(--color-forest-green)]/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent-gold)] focus-visible:ring-offset-2 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]">
        ...
        <div class="journey-book-modal bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto" role="dialog" aria-labelledby="journey-book-title" aria-modal="true">
            <div class="p-8 md:p-10">
                ...
                <form id="journey-book-form" class="space-y-5">
                    ...
                    <button type="submit" class="w-full inline-flex items-center justify-center gap-2 rounded-[var(--radius-button)] border border-[#25D366] bg-[#25D366] py-4 px-6 text-white font-semibold tracking-[0.04em] hover:bg-[#20bd5a] hover:border-[#20bd5a] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 transition-colors duration-200">
    ...
    <div id="journey-sticky-book" class="fixed hidden">
        <button type="button" id="journey-sticky-book-btn" class="journey-sticky-book inline-flex items-center gap-2 rounded-[var(--radius-button)] border border-[var(--color-forest-green)] bg-[var(--color-forest-green)] text-white font-semibold uppercase tracking-[0.04em] text-sm px-5 py-3.5 md:px-6 md:py-4 hover:bg-[var(--color-forest-green)]/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent-gold)] focus-visible:ring-offset-2 transition-all min-h-[44px]">
